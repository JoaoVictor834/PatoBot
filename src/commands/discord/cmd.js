...
module.exports = class extends Command.dCommand {
    ...
    run = async (interaction) => {
        ...
        if(command.startsWith('prefix') && (interaction.author.id !== '990061390029012992' || interaction.author.id !== '367751573067137034')) return interaction.reply({content: 'Prefix é coisa de gay!', ephemeral: true})
